    ...
    <div className="fixed top-24 right-6 z-40 animate-slide-in-right">
      ...
      {!isExpanded && (
        <button
          ...
          className="group relative flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 text-white rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105 animate-gentle-pulse animate-subtle-vibrate overflow-hidden"
      ...
      {isExpanded && (
        <div className="w-80 max-h-[480px] bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden animate-fade-in">
          {/* Header */}
          <div className="bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 text-white p-3 flex items-center justify-between">
